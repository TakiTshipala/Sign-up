...
const ButtonBrand = (props) => {
    ...
    let defaultClasses = "w-full text-white bg-brand border outline-none h-16 font-helvetica text-base rounded-xl tracking-wider px-4 py-2 mt-10 focus:shadow-outline-sm cursor-pointer"
